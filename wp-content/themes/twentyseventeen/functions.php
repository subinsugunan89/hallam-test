...
function tt_enqueue_scripts() {
  ...
  wp_localize_script( 'ajax-script', 'site_data',array( 'ajax_url' => admin_url( 'admin-ajax.php' ) ) );
}
...
function tt_get_quote(){
	 ...
	 $quote = get_transient( 'quote_of_the_day' );

	// $my_mood = get_transient( 'my_mood1' ); // Site Transient
